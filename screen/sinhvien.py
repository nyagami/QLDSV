...
class SinhVienTable(QDialog):
    ...
    def initUI(self):
        ...
        headers = ['Họ và tên', 'Mã Sinh Viên', 'Giới tính', 'Ngày sinh','Lớp','Ngành']
        ...
        self.setWindowTitle('Danh sách sinh viên')
        self.show()
...
class PersonalInfo(QDialog):
    ...
    def save_info(self):
        ...
        if not name or not gender or not code or not date or not lop or not major:
        ...
        self.parent().data.append({"name":name,"code":code, "gender":gender, "date":date, "lop":lop, "major":major})
